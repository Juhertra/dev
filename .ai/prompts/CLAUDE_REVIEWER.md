...
- When continuing an active patch, identify the next owned RUNBOOK phase from `.ai/RUNBOOK.md`, execute only that phase, then stop and report. Do not self-chain into later phases.
